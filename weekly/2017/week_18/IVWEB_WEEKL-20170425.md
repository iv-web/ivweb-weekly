## 文章索引
1、 <a href="#1文章-transcrypt剖析python转javascript编译器" >文章： Transcrypt：剖析Python转JavaScript编译器</a><br/>
2、 <a href="#2slack从javascript切换至typescript" >Slack从JavaScript切换至TypeScript</a><br/>
...
7、 <a href="#7fex-技术周刊---2017/04/24" >FEX 技术周刊 - 2017/04/24</a><br/>
...
12、 <a href="#12applications-of-machine-learning-for-designers" >Applications Of Machine Learning For Designers</a><br/><h1 id="#title_0" >1、文章： Transcrypt：剖析Python转JavaScript编译器</h1>
Jacques de Hooge
...
---------------
<h1 id="#title_1" >2、Slack从JavaScript切换至TypeScript</h1>
Sergio De Simone
...
---------------
<h1 id="#title_6" >7、FEX 技术周刊 - 2017/04/24</h1>
