## 文章索引
1、 <a href="#1android开发周报android免安装应用开放android-studio-30版本前瞻" >Android开发周报：Android免安装应用开放、Android Studio 3.0版本前瞻</a><br/>
2、 <a href="#2ios-开发周报苹果诺基亚专利大战最终和解用-swift-中的单向数据流来替代臃肿的视图控制器" >iOS 开发周报：苹果诺基亚专利大战最终和解、用 Swift 中的单向数据流来替代臃肿的视图控制器</a><br/>
3、 <a href="#3fex-技术周刊---2017/05/31" >FEX 技术周刊 - 2017/05/31</a><br/>
...
8、 <a href="#8xor-加密简介" >XOR 加密简介</a><br/>
9、 <a href="#9视频演讲-tera在百亿级实时搜索架构中的应用" >视频演讲： Tera在百亿级实时搜索架构中的应用</a><br/>
10、 <a href="#10视频演讲-程序猿如何进化云上的开发运维一体化" >视频演讲： 程序猿如何进化——云上的开发运维一体化</a><br/>
...
15、 <a href="#15good-vibes-and-summer-dreams:-joyful-wallpapers-for-your-desktop-june-2017-edition" >Good Vibes And Summer Dreams: Joyful Wallpapers For Your Desktop (June 2017 Edition)</a><br/><h1 id="#title_0" >1、Android开发周报：Android免安装应用开放、Android Studio 3.0版本前瞻</h1>
郭亮
...
---------------
<h1 id="#title_1" >2、iOS 开发周报：苹果诺基亚专利大战最终和解、用 Swift 中的单向数据流来替代臃肿的视图控制器</h1>
靛青K
...
---------------
<h1 id="#title_2" >3、FEX 技术周刊 - 2017/05/31</h1>
