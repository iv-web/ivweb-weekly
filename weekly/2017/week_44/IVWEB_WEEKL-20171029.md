## 文章索引
1、 <a href="#1每日一博-|-消息中间件集群部署测试与应用" >每日一博 | 消息中间件集群部署、测试与应用</a><br/>
2、 <a href="#2suse-linux-enterprise-15-beta-1-发布" >SUSE Linux Enterprise 15 Beta 1 发布</a><br/>
...
5、 <a href="#5开源中国-android-客户端-v290-发布" >开源中国 Android 客户端 v2.9.0 发布</a><br/>
6、 <a href="#6码云推荐-|-基于深度学习的分词系统和语料项目" >码云推荐 | 基于深度学习的分词系统和语料项目</a><br/>
7、 <a href="#7javamelody-1700-发布java-应用监控平台" >JavaMelody 1.70.0 发布，Java 应用监控平台</a><br/>
...
12、 <a href="#12mcafee-宣布不再允许政府检查其软件源码" >McAfee 宣布不再允许政府检查其软件源码</a><br/><h1 id="#title_0" >1、每日一博 | 消息中间件集群部署、测试与应用</h1>
...
---------------
<h1 id="#title_1" >2、SUSE Linux Enterprise 15 Beta 1 发布</h1>
...
---------------
<h1 id="#title_4" >5、开源中国 Android 客户端 v2.9.0 发布</h1>
...
---------------
<h1 id="#title_6" >7、JavaMelody 1.70.0 发布，Java 应用监控平台</h1>
