## 文章索引
1、 <a href="#1ios-开发周报苹果想用-iphone-管理你的医疗历史the-right-way-to-architect-ios-app-with-swift" >iOS 开发周报：苹果想用 iPhone 管理你的医疗历史、The Right Way to Architect iOS App with Swift</a><br/>
2、 <a href="#2android开发周报android-80开始推送微店插件化实践" >Android开发周报：Android 8.0开始推送、微店插件化实践</a><br/>
3、 <a href="#3文章-mxnet-api入门-第1篇" >文章： MXNet API入门 —第1篇</a><br/>
...
9、 <a href="#9学会思考而不只是编程" >学会思考，而不只是编程</a><br/>
10、 <a href="#10漫谈-js-函数式编程一" >漫谈 JS 函数式编程（一）</a><br/>
11、 <a href="#11文章-深入浅出tensorflow六tensorflow高层封装" >文章： 深入浅出TensorFlow（六）TensorFlow高层封装</a><br/>
...
16、 <a href="#16left-handed-brush-lettering:-how-to-get-started" >Left-Handed Brush Lettering: How To Get Started</a><br/><h1 id="#title_0" >1、iOS 开发周报：苹果想用 iPhone 管理你的医疗历史、The Right Way to Architect iOS App with Swift</h1>
靛青K
...
---------------
<h1 id="#title_1" >2、Android开发周报：Android 8.0开始推送、微店插件化实践</h1>
郭亮
...
---------------
<h1 id="#title_2" >3、文章： MXNet API入门 —第1篇</h1>
Julien Simon
...
---------------
<h1 id="#title_8" >9、学会思考，而不只是编程</h1>
Yevgeniy Brikman
...
---------------
<h1 id="#title_9" >10、漫谈 JS 函数式编程（一）</h1>
...
<p>-- 期待下一篇吧 --</p>
---------------
<h1 id="#title_10" >11、文章： 深入浅出TensorFlow（六）TensorFlow高层封装</h1>
郑泽宇
