## 文章索引
1、 <a href="#1ios-开发周报-苹果回应微信关闭赞赏通知ios-静态库动态库与-framework-都是什么" >iOS 开发周报： 苹果回应微信关闭赞赏通知、iOS 静态库、动态库与 Framework 都是什么</a><br/>
2、 <a href="#2android开发周报国内android份额飙升至864sdk无埋点技术解析" >Android开发周报：国内Android份额飙升至86.4%、SDK无埋点技术解析</a><br/>
3、 <a href="#3apple-testflight支持ios-app的a/b测试" >Apple TestFlight支持iOS App的A/B测试</a><br/>
4、 <a href="#4应用程序热补丁二自动生成热补丁" >应用程序热补丁（二）：自动生成热补丁</a><br/>
5、 <a href="#5c#将引入可空的引用类型" >C#将引入可空的引用类型</a><br/>
6、 <a href="#6使用organizational-hacks改善工作生活" >使用Organizational Hacks改善工作生活</a><br/>
7、 <a href="#7web-development-reading-list-#179:-firefox-53-the-top-web-browsers-and-vuejs-authentication" >Web Development Reading List #179: Firefox 53, The Top Web Browsers, And Vue.js Authentication</a><br/>
...
12、 <a href="#12#331:-arrow-functions-popular-js-patterns-and-react-vr" >#331: Arrow functions, popular JS patterns, and React VR</a><br/>
13、 <a href="#13jekyll-for-wordpress-developers" >Jekyll For WordPress Developers</a><br/><h1 id="#title_0" >1、iOS 开发周报： 苹果回应微信关闭赞赏通知、iOS 静态库、动态库与 Framework 都是什么</h1>
靛青K
...
---------------
<h1 id="#title_1" >2、Android开发周报：国内Android份额飙升至86.4%、SDK无埋点技术解析</h1>
郭亮
...
---------------
<h1 id="#title_2" >3、Apple TestFlight支持iOS App的A/B测试</h1>
Sergio De Simone
...
---------------
<h1 id="#title_3" >4、应用程序热补丁（二）：自动生成热补丁</h1>
王超
[http://www.infoq.com/cn/news/2017/04/Application-hot-patch-2?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2017/04/Application-hot-patch-2?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>在上篇文章中，我们介绍了应用程序热补丁技术的基本原理，同时实现了一个简单的热补丁。但是无法对本地函数打热补丁，同时手动编写热补丁比较麻烦、可能非常复杂容易出错。 为了解决这些问题，本文将会介绍一种自动生成应用程序热补丁技术，可以生成应用程序和动态链接库中任意函数的热补丁。</p> <i>By 王超</i>
---------------
<h1 id="#title_4" >5、C#将引入可空的引用类型</h1>
Jonathan Allen
[http://www.infoq.com/cn/news/2017/04/CSharp-Nullable?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2017/04/CSharp-Nullable?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>是的，标题没错。C#其中一份新提案假定，所有的引用类型在默认情况下都是不可空的。在新语法下，你需要显式地标明一个引用变量是可空的，就像对值类型所做的那样。</p> <i>By Jonathan Allen</i> <i> Translated by 谢丽</i>
---------------
<h1 id="#title_5" >6、使用Organizational Hacks改善工作生活</h1>
Ben Linders
[http://www.infoq.com/cn/news/2017/04/work-life-organizational-hacks?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2017/04/work-life-organizational-hacks?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
