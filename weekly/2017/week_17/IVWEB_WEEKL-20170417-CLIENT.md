## 文章索引
1、 <a href="#1android开发周报android份额超越windowsapk瘦身探索" >Android开发周报：Android份额超越Windows、Apk瘦身探索</a><br/>
2、 <a href="#2ios-开发周报迪拜独特艺术长廊-apple-store-建成使用-visual-studio-code-编写-swift-代码" >iOS 开发周报：迪拜独特艺术长廊 Apple Store 建成、使用 Visual Studio Code 编写 Swift 代码</a><br/>
3、 <a href="#3重新定义数据库历史的时刻" >重新定义数据库历史的时刻</a><br/>
4、 <a href="#4javascript-内存泄漏教程" >JavaScript 内存泄漏教程</a><br/>
...
8、 <a href="#8fex-技术周刊---2017/04/17" >FEX 技术周刊 - 2017/04/17</a><br/>
...
14、 <a href="#14visual-basic-15语言新特性" >Visual Basic 15语言新特性</a><br/><h1 id="#title_0" >1、Android开发周报：Android份额超越Windows、Apk瘦身探索</h1>
郭亮
...
---------------
<h1 id="#title_1" >2、iOS 开发周报：迪拜独特艺术长廊 Apple Store 建成、使用 Visual Studio Code 编写 Swift 代码</h1>
靛青K
...
---------------
<h1 id="#title_2" >3、重新定义数据库历史的时刻</h1>
足下
...
---------------
<h1 id="#title_3" >4、JavaScript 内存泄漏教程</h1>
阮一峰
...
---------------
<h1 id="#title_7" >8、FEX 技术周刊 - 2017/04/17</h1>
