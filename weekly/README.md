# WEEKLY LIST        
## 第11周文章列表       
1. [文章： 利用深度学习进行时序数据的异常检测](http://www.infoq.com/cn/articles/deep-learning-time-series-anomaly-detection?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)       
