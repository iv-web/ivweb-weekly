## 文章索引
1、 <a href="#1文章-可预见的敏捷交付" >文章： 可预见的敏捷交付</a><br/>
2、 <a href="#2视频演讲-浏览器端-javascript-异常监控-for-dummies" >视频演讲： 浏览器端 JavaScript 异常监控 For Dummies</a><br/>
...
9、 <a href="#9kuzzle一种内部部署的文档后端" >Kuzzle，一种内部部署的文档后端</a><br/>
...
17、 <a href="#17more-than-just-pretty:-how-imagery-drives-user-experience" >More Than Just Pretty: How Imagery Drives User Experience</a><br/><h1 id="#title_0" >1、文章： 可预见的敏捷交付</h1>
Russ Lewis
...
---------------
<h1 id="#title_1" >2、视频演讲： 浏览器端 JavaScript 异常监控 For Dummies</h1>
刘小杰
...
---------------
<h1 id="#title_8" >9、Kuzzle，一种内部部署的文档后端</h1>
Abel Avram
