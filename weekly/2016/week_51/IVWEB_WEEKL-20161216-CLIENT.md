## 文章索引
1、 <a href="#1android-android-从-0-开始自定义控件之-view-的-measure-过程七" >[Android] Android 从 0 开始自定义控件之 View 的 measure 过程（七）</a><br/>
2、 <a href="#2android-创造优秀的-android-应用离线体验" >[Android] 创造优秀的 Android 应用离线体验</a><br/>
3、 <a href="#3微软欲将手机变成真正的pc" >微软欲将手机变成真正的PC</a><br/>
4、 <a href="#4ios-objc-黑科技---method-swizzle-的一些注意事项" >[iOS] Objc 黑科技 - Method Swizzle 的一些注意事项</a><br/>
5、 <a href="#5文章-http-rpc轻量级跨平台rest框架" >文章： HTTP-RPC：轻量级跨平台REST框架</a><br/>
6、 <a href="#6android-网络框架分析" >[Android] 网络框架分析</a><br/>
7、 <a href="#7ios-实践sonar-xcode8-兼容" >[iOS] [实践]Sonar XCode8 兼容</a><br/>
8、 <a href="#8视频访谈-王伟冰百度贴吧的私有云改造" >视频访谈： 王伟冰：百度贴吧的私有云改造</a><br/>
...
11、 <a href="#11前端-手把手教你开发电商类小程序-vol1-|-实战教程" >[前端] 手把手教你开发电商类小程序 Vol.1 | 实战教程</a><br/>
12、 <a href="#12工具资源-setapp每月-99-美金订阅即可免费使用超过-50-款优质付费-mac-软件" >[工具资源] Setapp：每月 9.9 美金订阅即可免费使用超过 50 款优质付费 mac 软件</a><br/>
13、 <a href="#13前端-vue-quill-editor-基于quill适用于vue2的富文本编辑器" >[前端] Vue-Quill-Editor 基于Quill、适用于Vue2的富文本编辑器</a><br/>
14、 <a href="#14文章-解读2016之golang篇极速提升逐步成熟" >文章： 解读2016之Golang篇：极速提升，逐步成熟</a><br/>
15、 <a href="#15后端-译-500-行-python-代码实现一个功能系列之实现一个最简单的对象模型" >[后端] [译]-500 行 Python 代码实现一个功能系列之：实现一个最简单的对象模型</a><br/>
16、 <a href="#16设计-多端统一内容至上---腾讯-isux" >[设计] 多端统一，内容至上 - 腾讯 ISUX</a><br/>
17、 <a href="#17this-weeks-javascript-news-issue-314" >This week's JavaScript news, issue 314</a><br/>
18、 <a href="#18设计-2000+-分类齐全的精致-icon-图标下载" >[设计] 2000+ 分类齐全的精致 icon 图标下载</a><br/>
19、 <a href="#19typescript-21发布" >TypeScript 2.1发布</a><br/>
20、 <a href="#20产品-做不到营销场景化你的-app-活动怎能打动用户内心" >[产品] 做不到营销场景化，你的 app 活动怎能打动用户内心</a><br/>
21、 <a href="#21文章-fastlane实战五高级用法" >文章： Fastlane实战（五）：高级用法</a><br/>
...
24、 <a href="#24阅读-小程序微信支付不完全接入指南" >[阅读] 小程序微信支付不完全接入指南</a><br/><h1 id="#title_0" >1、[Android] Android 从 0 开始自定义控件之 View 的 measure 过程（七）</h1>
Airsaid
[https://gold.xitu.io/entry/5852b3051b69e6006c8200ae](https://gold.xitu.io/entry/5852b3051b69e6006c8200ae)
<img src="https://dn-mhke0kuv.qbox.me/e1a858e39affb28d3ec6.JPG?imageView/2/w/800/h/600/q/80/format/png"/><p>measure 过程要分两种情况，第一种是 View，第二种是 ViewGroup。如果是 View 的话，那么只通过 measure 方法就完成其测量过程，但是如果是 ViewGroup 的话，不仅需要完成自己的测量过程，还需要完成它所有子 View 的测量过程。如果子 View 又是一个 ViewGroup，那么继续递归这个流程。下面先从 View 开始，详细了解下 View 的 measure 过程。</p><p></p>
---------------
<h1 id="#title_1" >2、[Android] 创造优秀的 Android 应用离线体验</h1>
D_clock爱吃葱花
[https://gold.xitu.io/entry/5852aa7461ff4b006c895a76](https://gold.xitu.io/entry/5852aa7461ff4b006c895a76)
<img src="https://dn-mhke0kuv.qbox.me/d0f4744cf96bb18bfa9a.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>最近几年，Google、Microsoft、Facebook 等公司都不约而同的盯上了非洲大陆。为了能更好服务像这样网络条件很差的用户，作者在这里分享了你可以怎样组织自己 Android 应用的离线架构。文章不错，推荐阅读。</p><p></p>
---------------
<h1 id="#title_2" >3、微软欲将手机变成真正的PC</h1>
薛命灯
...
---------------
<h1 id="#title_3" >4、[iOS] Objc 黑科技 - Method Swizzle 的一些注意事项</h1>
SwiftCafe
...
---------------
<h1 id="#title_4" >5、文章： HTTP-RPC：轻量级跨平台REST框架</h1>
Greg Brown
...
</table><p>With the holidays almost here and the new year already in sight, December is a time to slow down, an occasion to reflect and plan ahead. To help us escape the everyday hectic for a bit and sweeten our days with a delightful little surprise each day up to Christmas, the web community has assembled some fantastic advent calendars this year. They cater for a <strong>daily dose of web design and development goodness</strong> with stellar articles, inspiring experiments, and even puzzles to solve.</p>
...
<img src="https://dn-mhke0kuv.qbox.me/53b7a7d3d1c3db0d57f7.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>以前用盗版软件的时候，总在心里说：等我负担的起软件的费用时，我就去用正版的，现在是时候了。</p><p></p>
---------------
<h1 id="#title_12" >13、[前端] Vue-Quill-Editor 基于Quill、适用于Vue2的富文本编辑器</h1>
Surmon
...
---------------
<h1 id="#title_13" >14、文章： 解读2016之Golang篇：极速提升，逐步成熟</h1>
郝林
...
---------------
<h1 id="#title_14" >15、[后端] [译]-500 行 Python 代码实现一个功能系列之：实现一个最简单的对象模型</h1>
Zheaoli
...
---------------
<h1 id="#title_15" >16、[设计] 多端统一，内容至上 - 腾讯 ISUX</h1>
AleCC
...
微云 WEB 端与移动端体验不一致。移动互联网背景下，项目团队把多数资源都分配给了移动端的研发，桌面端的功能和体验得不到及时的跟进，导致用户在两个平台上的体验存在很大的落差。

微云 WEB 端的设计较为陈旧。苹果 iOS 的快速发展使得整个 UI 设计行业日新月异，设计理念不断进化向前，微云 WEB 端的设计已经多年未更新，早已经不起当下设计原则的检验。</p><p></p>
---------------
<h1 id="#title_16" >17、This week's JavaScript news, issue 314</h1>
