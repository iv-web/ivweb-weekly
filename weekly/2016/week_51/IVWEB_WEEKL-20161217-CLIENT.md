## 文章索引
1、 <a href="#1ios-ios-图像处理---一种高效裁剪图片圆角的算法" >[iOS] [iOS] 图像处理 - 一种高效裁剪图片圆角的算法</a><br/>
2、 <a href="#2ios-开发周报-苹果公布-2016-年度-app-&-游戏榜单到年底了为什么不在-ios-上尝试-rex-呢" >iOS 开发周报： 苹果公布 2016 年度 App & 游戏榜单、到年底了，为什么不在 iOS 上尝试 ReX 呢？</a><br/>
3、 <a href="#3android开发周报谷歌开发者大会在京召开android秒级编译详解" >Android开发周报：谷歌开发者大会在京召开、Android秒级编译详解</a><br/>
4、 <a href="#4android-启航---设计模式与-android-源码-篇二" >[Android] 启航 - 设计模式与 Android 源码 (篇二)</a><br/>
5、 <a href="#5android-有几个基类-用dagger注入几个工具类就敢叫mvp+dagger框架" >[Android] 有几个基类, 用Dagger注入几个工具类就敢叫MVP+Dagger框架？</a><br/>
6、 <a href="#6解放双手发掘更大的价值智能化运维" >解放双手，发掘更大的价值：智能化运维</a><br/>
...
9、 <a href="#9前端-vuejs-20-迁移指南" >[前端] Vue.js 2.0 迁移指南</a><br/>
10、 <a href="#10前端-react-native-的组件通信方式" >[前端] React Native 的组件通信方式</a><br/>
11、 <a href="#11最新java-9时间表看上去自开始就存在风险" >最新Java 9时间表看上去自开始就存在风险</a><br/>
12、 <a href="#12译配置一个简单而实用的-javascript-开发环境" >【译】配置一个简单而实用的 JavaScript 开发环境</a><br/>
13、 <a href="#13前端-奇舞周刊第-189-期" >[前端] 奇舞周刊第 189 期</a><br/>
14、 <a href="#14后端-spring-cloud-netflix-概览和架构设计-|-掘金技术征文" >[后端] Spring Cloud netflix 概览和架构设计 | 掘金技术征文</a><br/>
15、 <a href="#15银联实验室发布金融sdn技术能力评测标准草案" >银联实验室发布《金融SDN技术能力评测标准》草案</a><br/>
16、 <a href="#16mistakes-developers-make-when-learning-design" >Mistakes Developers Make When Learning Design</a><br/><h1 id="#title_0" >1、[iOS] [iOS] 图像处理 - 一种高效裁剪图片圆角的算法</h1>
androidwing
...
---------------
<h1 id="#title_1" >2、iOS 开发周报： 苹果公布 2016 年度 App & 游戏榜单、到年底了，为什么不在 iOS 上尝试 ReX 呢？</h1>
靛青K
...
---------------
<h1 id="#title_2" >3、Android开发周报：谷歌开发者大会在京召开、Android秒级编译详解</h1>
郭亮
...
---------------
<h1 id="#title_3" >4、[Android] 启航 - 设计模式与 Android 源码 (篇二)</h1>
szysky
...
---------------
<h1 id="#title_4" >5、[Android] 有几个基类, 用Dagger注入几个工具类就敢叫MVP+Dagger框架？</h1>
jessyan
...
---------------
<h1 id="#title_5" >6、解放双手，发掘更大的价值：智能化运维</h1>
孟夕
...
---------------
<h1 id="#title_11" >12、【译】配置一个简单而实用的 JavaScript 开发环境</h1>
