...
王子建
[http://gold.xitu.io/entry/582dce6ea0bb9f0067ac0b4e](http://gold.xitu.io/entry/582dce6ea0bb9f0067ac0b4e)
<img src="http://ac-mhke0kuv.clouddn.com/f64ca3f9cec0839c6de9.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>再努力也做不出完美的动画？可能是你没有遵守这十个原则！</p><p></p>
---------------
<h1 id="#title_10" >11、[前端] 推荐一款带暂停功能的轮播组件，不要谢我，我叫红领巾！</h1>
极乐君
[http://gold.xitu.io/entry/582db99f570c35006cf2652c](http://gold.xitu.io/entry/582db99f570c35006cf2652c)
<img src="http://ac-mhke0kuv.clouddn.com/c895c043375ab73eace9.png?imageView/2/w/800/h/600/q/80/format/png"/><p>关于轮播组件，那肯定是一搜一大把，实在不行自己写貌似也不难。最近博主在项目中用到一款轮播组件，功能齐全，可以设置各种标题样式、动画效果、轮播时间、开始暂停等功能，在此推荐给大家，供大家参考。相信有你需要的效果。</p><p></p>
---------------
<h1 id="#title_11" >12、[前端] wxSearch - 微信小程序优雅的搜索框开源组件</h1>
微信小程序开发论坛-weappdev
[http://gold.xitu.io/entry/582e4889a22b9d006b734a3f](http://gold.xitu.io/entry/582e4889a22b9d006b734a3f)
<img src="http://ac-mhke0kuv.clouddn.com/bec35ba29633c3c7e9f0.png?imageView/2/w/800/h/600/q/80/format/png"/><p>wxSearch -开源微信小程序优雅的搜索框组件信息
版本号 0.1
...
垂直微信小程序开发交流社区</p><p></p>
---------------
<h1 id="#title_12" >13、文章： SAM模式：构建函数响应式前端架构过程中学到的经验</h1>
Gunar C. Gessner, Jean-Jacques Dubray
[http://www.infoq.com/cn/articles/sam-lessons-learned-front-end-reactive-architectures?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/sam-lessons-learned-front-end-reactive-architectures?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/articles/sam-lessons-learned-front-end-reactive-architectures/zh/smallimage/logo2.jpg"/><p>现代化用户体验要求所用架构不仅要能持续“响应”用户输入，而且要能对不同类型的环境做出响应。Jean-Jacques Dubray和Gunar C. Gessner通过本文探讨了通过不同框架和库实现SAM模式过程中学到的经验。</p> <i>By Gunar C. Gessner, Jean-Jacques Dubray</i> <i> Translated by 大愚若智</i>
---------------
<h1 id="#title_13" >14、[后端] Riddler 助力 Docker 容器为 runC 运行环境做准备</h1>
Docker精选
[http://gold.xitu.io/entry/582e433e2f301e0059534738](http://gold.xitu.io/entry/582e433e2f301e0059534738)
<img src="http://ac-mhke0kuv.clouddn.com/732c39fb024102f12c67.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>本文主要是介绍 Riddler 工具，讲解 Riddler 为开发者带来的便利，并对基本使用进行了介绍和解释。</p><p></p>
---------------
<h1 id="#title_14" >15、[后端] JDK 自带工具之问题排查场景示例</h1>
飒然Hang
[http://gold.xitu.io/entry/582dd377570c35006cf38829](http://gold.xitu.io/entry/582dd377570c35006cf38829)
<p>讲述了使用 jdk 自带工具排查 java 问题的几个场景。</p><p></p>
---------------
<h1 id="#title_15" >16、视频演讲： 知乎万级规模容器平台架构和实战</h1>
张阜兴
[http://www.infoq.com/cn/presentations/platform-architecture-and-combatof-zhihu-container-platform?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/presentations/platform-architecture-and-combatof-zhihu-container-platform?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/presentations/platform-architecture-and-combatof-zhihu-container-platform/zh/mediumimage/zhangfuxing_270.jpg"/><p>随着知乎规模的迅速发展和内部服务化架构的演进，业务需要更好的环境隔离和动态的资源调度。知乎采用Mesos+Docker容器方式构建弹性计算平台，配合Consul和Haproxy进行服务发现及负载均衡，并结合持续集成系统提升业务的整体开发效率。目前，知乎绝大部分业务都已经平稳的运行在该平台之上。本次分享主要包括：1、知乎容器化历程；2、架构选择和设计；3、实践中遇到的问题；4、经验总结及感悟</p> <i>By 张阜兴</i>
---------------
<h1 id="#title_16" >17、Rust 1.13带来新的错误处理操作符?并改进了性能</h1>
Sergio De Simone
[http://www.infoq.com/cn/news/2016/11/rust-113-released?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2016/11/rust-113-released?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>在1.13版本中，Rust核心团队的主要工作是通过引入新操作符？改进该语言的错误处理语法、优化编译时间以及新增对类型级宏的支持。</p> <i>By Sergio De Simone</i> <i> Translated by 谢丽</i>
---------------
<h1 id="#title_17" >18、Facebook是如何支持80万并发视频流直播的</h1>
High Scalability
[http://www.infoq.com/cn/news/2016/11/Facebook-80-Live-video-stream?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2016/11/Facebook-80-Live-video-stream?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>具备构建横跨全球的分布式服务能力的公司寥寥无几，甚至比拥有核武器的国家还要少。然而，Facebook就是这样的一个公司，它的视频流直播系统Facebook Live就是一个横跨世界的分布式服务。那么Facebook是如何做到支持80万并发视频流直播的呢？</p> <i>By High Scalability</i> <i> Translated by 薛命灯</i>
---------------
<h1 id="#title_18" >19、[阅读] 多动态图详细讲解二叉搜索树</h1>
lufficc
[http://gold.xitu.io/entry/582dc029128fe1006959a419](http://gold.xitu.io/entry/582dc029128fe1006959a419)
<img src="http://ac-mhke0kuv.clouddn.com/56bdf455f734250caf37.png?imageView/2/w/800/h/600/q/80/format/png"/><p>多动态图详细讲解二叉搜索树，包括遍历、查询、最大值最小值、前驱后继、插入、删除等操作。</p><p></p>
---------------
<h1 id="#title_19" >20、视频演讲： 跨过技术创业的那些坎儿</h1>
胡宁
[http://www.infoq.com/cn/presentations/across-the-ditch-of-technology-entrepreneurship?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/presentations/across-the-ditch-of-technology-entrepreneurship?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/presentations/across-the-ditch-of-technology-entrepreneurship/zh/mediumimage/huning_270.jpg"/><p>工程师怀抱用技术改变世界的理想，走上创业这条艰险的道路，是一个代价极 大、失败率极高、但可能的收获也巨大的人生选择。创业的道路上，处处充满了荆棘和坎坷。尤其是对处事比较单纯的技术人员来说，碰到的一些挫折甚至有可能会对其世界观产生冲击。
此次演讲会从自身创业经历出发，讨论技术创业过程中会碰到的那些坎儿，并给出如何应对的建议：从技术创业方向的选择，到商业模式的确定；从股权的架构设计和分配，到团队的建设和管理；从产品节奏和质量的控制，到研发及升级流程的完善；从对现金流的把握，到融资计划的执行；从企业成长的烦恼，到退出路径的抉择。
创业维艰。希望此次演讲，能给予正在创业或希望创业的技术人员一些启迪。</p> <i>By 胡宁</i>
---------------
<h1 id="#title_20" >21、文章： Realm Java 原理介绍以及常见问题</h1>
陈牧龙
[http://www.infoq.com/cn/articles/introduce-and-common-problems-of-java-realm-principle?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/introduce-and-common-problems-of-java-realm-principle?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/articles/introduce-and-common-problems-of-java-realm-principle/zh/smallimage/change_logo.jpg"/><p>Realm 是一个 MVCC 数据库 ，底层用 C++ 编写。MVCC 指的是多版本并发控制。MVCC 解决了一个重要的并发问题：在所有的数据库中都有这样的时候，当有人正在写数据库的时候有人又想读取数据库了（例如，不同的线程可以同时读取或者写入同一个数据库）。这会导致数据的不一致性 - 可能当你读取记录的时候一个写操作才部分结束。如果数据库允许这种事情发生，你就会得到和最终数据库里的数据不一致的数据。</p> <i>By 陈牧龙</i>
---------------
<h1 id="#title_21" >22、文章： 为什么要进行日志测试和如何进行日志测试</h1>
Matthew Skelton, Manuel Pais
[http://www.infoq.com/cn/articles/why-test-logging?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/why-test-logging?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/articles/why-test-logging/zh/smallimage/logo-devops.jpg"/><p>日志和日志聚合系统对于现今复杂的分布式系统是非常关键的工具。在保持了快速恢复之外还可以提供丰富的洞察。我们因此必须保证对日志进行了非常充分的测试。</p> <i>By Matthew Skelton, Manuel Pais</i> <i> Translated by 足下</i>
---------------
<h1 id="#title_22" >23、[Android] Android 从 0 开始自定义控件之 View 的弹性滑动（三）</h1>
Airsaid
...
---------------
<h1 id="#title_23" >24、[阅读] 如何用 C 语言画几何图形？</h1>
Absfree
[http://gold.xitu.io/entry/582e4d0b2f301e0059538283](http://gold.xitu.io/entry/582e4d0b2f301e0059538283)
<p>腾讯技术总监叶大的科普文，采用了 Ray-casting 的思想用 C 语言画各种几何图形</p><p></p>
---------------
<h1 id="#title_24" >25、[工具资源] Git 版本控制与工作流</h1>
IT程序狮
[http://gold.xitu.io/entry/582dac5a8ac2470061a127a7](http://gold.xitu.io/entry/582dac5a8ac2470061a127a7)
<img src="http://ac-mhke0kuv.clouddn.com/766cbf617b039c84e4ff.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>这篇文章是针对 Git 版本控制和工作流的总结。很实用的一篇文章，值得推荐。</p><p></p>
---------------
<h1 id="#title_25" >26、探讨当前关于移动应用程序的国际化翻译多元问题</h1>

[http://www.ibm.com/developerworks/cn/mobile/mo-cn-translation/index.html?ca=drs-](http://www.ibm.com/developerworks/cn/mobile/mo-cn-translation/index.html?ca=drs-)
...
---------------
<h1 id="#title_27" >28、浅析 iOS 应用开发中的断点续传</h1>

[http://www.ibm.com/developerworks/cn/mobile/mo-cn-breakpoint/index.html?ca=drs-](http://www.ibm.com/developerworks/cn/mobile/mo-cn-breakpoint/index.html?ca=drs-)
...
---------------
<h1 id="#title_28" >29、iOS 辅助功能 VoiceOver</h1>

[http://www.ibm.com/developerworks/cn/mobile/mo-cn-voiceover/index.html?ca=drs-](http://www.ibm.com/developerworks/cn/mobile/mo-cn-voiceover/index.html?ca=drs-)
VoiceOver 是苹果手机上一个给视力不好或者盲人使用应用程序的语音辅助软件，语音提示使用者当前触碰到的屏幕信息，帮助使用者操控设备。
...
[http://www.ibm.com/developerworks/cn/mobile/mo-mobile-application-security-bluemix-mobile-services-1-trs/index.html?ca=drs-](http://www.ibm.com/developerworks/cn/mobile/mo-mobile-application-security-bluemix-mobile-services-1-trs/index.html?ca=drs-)
