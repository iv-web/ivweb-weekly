## 文章索引
1、 <a href="#1android-基础篇章关于-react-native-之-viewpagerandroid-组件的讲解" >[Android] 基础篇章：关于 React Native 之 ViewPagerAndroid 组件的讲解</a><br/>
2、 <a href="#2android-直播项目之仿全民-tv已开源" >[Android] 直播项目之仿全民 TV（已开源）</a><br/>
3、 <a href="#3android-经典-builder-/-变种-builder-模式及自动化生成代码插件" >[Android] 经典 Builder / 变种 Builder 模式及自动化生成代码插件</a><br/>
4、 <a href="#4android-rxbinding-解析顺便模仿-rxbinding-做个-rxanimation" >[Android] RxBinding 解析，顺便模仿 RxBinding 做个 RxAnimation</a><br/>
5、 <a href="#5ios-开发周报-apple-停止了-airport-产品线开发apple-开源-macos-1012-sierra-darwin-代码" >iOS 开发周报： Apple 停止了 AirPort 产品线开发、Apple 开源 macOS 10.12 Sierra Darwin 代码</a><br/>
6、 <a href="#6android开发周报cm-71体验版发布buck构建工程实战" >Android开发周报：CM 7.1体验版发布、Buck构建工程实战</a><br/>
...
13、 <a href="#13后端-jsp-一个装配工的没落" >[后端] JSP： 一个装配工的没落</a><br/>
14、 <a href="#14前端-前端阅读笔记-2016-12-01" >[前端] 前端阅读笔记 2016-12-01</a><br/>
...
20、 <a href="#20前端-2016-年前端开发者深度调研看看别人使用什么技术体系" >[前端] 2016 年前端开发者深度调研，看看别人使用什么技术体系</a><br/>
21、 <a href="#21视频演讲-在线服务的流量管控实践" >视频演讲： 在线服务的流量管控实践</a><br/>
22、 <a href="#22在离岸开发中扩展敏捷开发" >在离岸开发中扩展敏捷开发</a><br/>
23、 <a href="#23前端-css3-实现的-3d-相册效果" >[前端] CSS3 实现的 3D 相册效果</a><br/>
24、 <a href="#24this-weeks-javascript-news-issue-312" >This week's JavaScript news, issue 312</a><br/>
...
27、 <a href="#27freebie:-christmas-advent-icon-set-25-icons-ai-eps-svg-png-pdf" >Freebie: Christmas Advent Icon Set (25 Icons, AI, EPS, SVG, PNG, PDF)</a><br/><h1 id="#title_0" >1、[Android] 基础篇章：关于 React Native 之 ViewPagerAndroid 组件的讲解</h1>
涩郎
[http://gold.xitu.io/entry/5840b42a0ce463005767bc37](http://gold.xitu.io/entry/5840b42a0ce463005767bc37)
<p>我知道你们是不会看的。</p><p></p>
---------------
<h1 id="#title_1" >2、[Android] 直播项目之仿全民 TV（已开源）</h1>
逆流的鱼yuiop
[http://gold.xitu.io/entry/5840b12861ff4b00587c8e65](http://gold.xitu.io/entry/5840b12861ff4b00587c8e65)
<p>直播项目之仿全民 TV（已开源）</p><p></p>
---------------
<h1 id="#title_2" >3、[Android] 经典 Builder / 变种 Builder 模式及自动化生成代码插件</h1>
青蛙ing
[http://gold.xitu.io/entry/58404204ac502e006cbee49c](http://gold.xitu.io/entry/58404204ac502e006cbee49c)
<img src="https://dn-mhke0kuv.qbox.me/a74f7ef67b4427971cc4.jpeg?imageView/2/w/800/h/600/q/80/format/png"/><p>本人在简书中写的一篇文章。关于 Builder 的经典模式和变种模式。然后还有自动生成 Builder 代码的 Android Studio 插件。</p><p></p>
---------------
<h1 id="#title_3" >4、[Android] RxBinding 解析，顺便模仿 RxBinding 做个 RxAnimation</h1>
deadline
[http://gold.xitu.io/entry/58404ba8a22b9d007a867a3c](http://gold.xitu.io/entry/58404ba8a22b9d007a867a3c)
<img src="https://dn-mhke0kuv.qbox.me/5810ba087e584be5f1e7.jpeg?imageView/2/w/800/h/600/q/80/format/png"/><p>RxBinding 解析，顺便模仿 RxBinding 做个 RxAnimation</p><p></p>
---------------
<h1 id="#title_4" >5、iOS 开发周报： Apple 停止了 AirPort 产品线开发、Apple 开源 macOS 10.12 Sierra Darwin 代码</h1>
靛青K
...
---------------
<h1 id="#title_5" >6、Android开发周报：CM 7.1体验版发布、Buck构建工程实战</h1>
郭亮
...
<p>有幸得到老大给的 Velocity 大会门票，屁颠屁颠跑去听分享。下面是今天（第一天）的笔记。记得比较简略，凑合看吧。PPT 下载通道已经放出来了，感兴趣的可以自己跟踪一下。嫌微信编辑体验不好的，可以点击文章末尾的 “阅读原文” 查看。</p><p></p>
---------------
<h1 id="#title_7" >8、[后端] Python150 行代码实现验证码自动识别</h1>
拉丁吴
[http://gold.xitu.io/entry/5840419e61ff4b006b870562](http://gold.xitu.io/entry/5840419e61ff4b006b870562)
<img src="https://dn-mhke0kuv.qbox.me/58ad5fef276e47230257.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>这个也是我上学的时候写的一个基于 python 的简单的验证码识别程序，当时感觉还蛮有意思的。

我整理了一下，里面注释还算详细，所以就不用过多解释了

相信对于深入学习 python 的同学还是很有帮助的。</p><p></p>
---------------
<h1 id="#title_8" >9、[后端] 命令式编程 vs 声明式编程</h1>
刘欣
[http://gold.xitu.io/entry/5840317ca22b9d006c1007b8](http://gold.xitu.io/entry/5840317ca22b9d006c1007b8)
<img src="https://dn-mhke0kuv.qbox.me/195ea200b9a7137308ab.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>命令式编程 vs 声明式编程</p><p></p>
---------------
<h1 id="#title_9" >10、[后端] 一篇 SSM 框架整合友好的文章（二）</h1>
方志朋
[http://gold.xitu.io/entry/584035b9a22b9d007a85e8a7](http://gold.xitu.io/entry/584035b9a22b9d007a85e8a7)
<img src="https://dn-mhke0kuv.qbox.me/644b105fe4965255bcf1.jpg?imageView/2/w/800/h/600/q/80/format/png"/><p>一篇 SSM 框架整合友好的文章（二）</p><p></p>
---------------
<h1 id="#title_10" >11、[后端] 三层架构和 MVC 那点事儿</h1>
刘欣
[http://gold.xitu.io/entry/584031ad0ce4630057660a5f](http://gold.xitu.io/entry/584031ad0ce4630057660a5f)
<img src="https://dn-mhke0kuv.qbox.me/5e9bdc4f9a04eb3b9ad5.png?imageView/2/w/800/h/600/q/80/format/png"/><p>三层架构和 MVC 那点事儿</p><p></p>
---------------
<h1 id="#title_11" >12、文章： 字节码操纵技术探秘</h1>
Victor Grazi
[http://www.infoq.com/cn/articles/Living-Matrix-Bytecode-Manipulation?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/Living-Matrix-Bytecode-Manipulation?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/articles/Living-Matrix-Bytecode-Manipulation/zh/smallimage/logo-java.jpg"/><p>在本文中，我们将会深入学习两个流行的字节码操纵框架Javassist和ASM。字节码操纵技术应用到了像Spring和Hibernate这样的Java库、大多数的JVM语言甚至我们的IDE中。另外，它也确实非常有趣，所以这是一项很有价值的技术，掌握它之后，我们就能完成一些靠其他技术无法实现的任务。一旦学会之后，我们的发挥空间是无限的！</p> <i>By Victor Grazi</i> <i> Translated by 张卫滨</i>
---------------
<h1 id="#title_12" >13、[后端] JSP： 一个装配工的没落</h1>
刘欣
...
---------------
<h1 id="#title_13" >14、[前端] 前端阅读笔记 2016-12-01</h1>
文蔺
...
因为发了参加 velocity 2016 第一天的笔记，所以将阅读笔记放在凌晨 12 点后发送。</p><p></p>
---------------
<h1 id="#title_14" >15、[阅读] 微博 CEO 王高飞：微博与阿里、今日头条、社交电商的关系</h1>
achilles
[http://gold.xitu.io/entry/5840306c61ff4b006b867f0f](http://gold.xitu.io/entry/5840306c61ff4b006b867f0f)
<p>在中国百亿美金市值的互联网公司中，微博比较独特。这个独特体现在，从明星级产品到增速放缓遭受质疑，再重新回到行业中心舞台，微博七年多来的发展轨迹几乎没有先例。</p><p></p>
---------------
<h1 id="#title_15" >16、视频演讲： Netflix基于微服务和Docker的实时数据处理实践</h1>
徐振中
[http://www.infoq.com/cn/presentations/real-time-data-processing-based-on-docker-and-netflix?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/presentations/real-time-data-processing-based-on-docker-and-netflix?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/presentations/real-time-data-processing-based-on-docker-and-netflix/zh/mediumimage/xuzhengzhongam_270.jpg"/><p>Netflix目前日处理1 trillion events数据，峰值每秒流量12.5 million/35GB。过去两年之内数据量增涨超过一个数量级。本次分享将会重点介绍Netflix是如何在一年时间之内搭建和维护如此级别的实时数据处理平台，另外也会剖析平台微服务基础构架和Docker等容器生态系统的原则，以及期间遇到的挑战、问题和我们的处理方法。</p> <i>By 徐振中</i>
---------------
<h1 id="#title_16" >17、视频演讲： 给平民的 Mousejack</h1>
刘凯仁
[http://www.infoq.com/cn/presentations/the-mousejack-to-civilian?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/presentations/the-mousejack-to-civilian?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/presentations/the-mousejack-to-civilian/zh/mediumimage/liukairen_270.jpg"/><p>国内目前两个比较完整 mousejack 研究与实现：
...
这次的研究主要是看，是不是真的除了昂贵的 crazyradio，完全没有办法；国内的那么多款式 nRF24LU1 + PA + LAN 是否可以实现。
这次的演讲主题是——如何可以在少于 50 元的 USB 模块实现。</p> <i>By 刘凯仁</i>
---------------
<h1 id="#title_17" >18、文章： 隆重推荐Winston – 事件驱动的诊断和补救平台</h1>
Sayli Karmarkar、Vinay Shah
[http://www.infoq.com/cn/articles/winston-event-driven-diagnostic-and-remedial-platform?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/winston-event-driven-diagnostic-and-remedial-platform?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/articles/winston-event-driven-diagnostic-and-remedial-platform/zh/smallimage/logoRabbit.jpg"/><p>Winston为Netflix工程师提供了一种事件驱动的Runbook自动化平台。按照设计该平台可以托管Runbook，并作为对警报等运维事件的响应运行这些Runbook。Winston的目标是为开发者提供Tier-1支持，帮助开发者免除重复的诊断和补救任务，在遇到相关事件后自动执行必要操作。</p> <i>By Sayli Karmarkar、Vinay Shah</i> <i> Translated by 大愚若智</i>
---------------
<h1 id="#title_18" >19、文章： 在大学中教授现代软件开发技能</h1>
Robert Chatley
[http://www.infoq.com/cn/articles/teaching-software-development-university?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/teaching-software-development-university?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/articles/teaching-software-development-university/zh/smallimage/agile-logo.jpg"/><p>现代大学中的软件工程学位教育，总是与产业界实际工程需求间存在着不同程度的差距。学校预先制定的教学大纲总会与软件产业的频繁改进间存在不匹配的问题，这类似于敏捷开发所致力于解决的问题。本文阐述了伦敦帝国理工大学在教学中的应用敏捷理念的探索及实践，并对学校所开展的教学项目进行了介绍。</p> <i>By Robert Chatley</i> <i> Translated by Rays</i>
---------------
<h1 id="#title_19" >20、[前端] 2016 年前端开发者深度调研，看看别人使用什么技术体系</h1>
王下邀月熊
...
---------------
<h1 id="#title_20" >21、视频演讲： 在线服务的流量管控实践</h1>
刘魁（骏征）
[http://www.infoq.com/cn/presentations/practice-of-online-service-flow-control?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/presentations/practice-of-online-service-flow-control?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/resource/presentations/practice-of-online-service-flow-control/zh/mediumimage/liukui_200.jpg"/><p>Tengine 接入层的技术方案，旨在更有效的保护后端资源，提升服务的稳定性和容灾能力。本次演讲，主要分享在服务限流和七层负载流量切换（L7）上的业务实践。服务限流包括集群限流和单机本地限流；L7 包括手动和自动切换，是结合 DNS 四层切换的一种快速流量切换方案。</p> <i>By 刘魁（骏征）</i>
---------------
<h1 id="#title_21" >22、在离岸开发中扩展敏捷开发</h1>
Ben Linders
[http://www.infoq.com/cn/news/2016/12/stretching-agile-offshore?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2016/12/stretching-agile-offshore?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>为了能够在离岸软件开发时仍然使用敏捷开发，你必须投入大量时间，保证即使在敏捷方法不能产生预期效果的情况下也可以实现敏捷实践。Xavier Rene-Corail和Ionuț Baloșin认为，放弃敏捷开发并不是一个很好的选择，你需要通过回溯到敏捷原则，协作的方法来扩展敏捷方法，并让它们在分布式环境下也能有效运作。</p> <i>By Ben Linders</i> <i> Translated by 刘嘉洋</i>
---------------
<h1 id="#title_22" >23、[前端] CSS3 实现的 3D 相册效果</h1>
luckykun
...
---------------
<h1 id="#title_23" >24、This week's JavaScript news, issue 312</h1>
