## 文章索引
1、 <a href="#1谷歌开源针对ios的可访问性测试框架" >谷歌开源针对iOS的可访问性测试框架</a><br/>
2、 <a href="#2文章-electron工具包介绍:用于构建和启动electron应用程序的electron应用" >文章： electron工具包介绍:用于构建和启动Electron应用程序的Electron应用</a><br/>
3、 <a href="#3文章-深入浅出java-10的实验性jit编译器graal" >文章： 深入浅出Java 10的实验性JIT编译器Graal</a><br/>
4、 <a href="#4视频演讲-大规模分布式系统架构下调测能力构建之道" >视频演讲： 大规模分布式系统架构下调测能力构建之道</a><br/>
5、 <a href="#5talk-is-cheap-show-me-the-architecture" >Talk is cheap, show me the architecture</a><br/>
6、 <a href="#6在docker-compose上使用gpu运行tensorflow" >在Docker Compose上使用GPU运行TensorFlow</a><br/>
7、 <a href="#7文章-不你可能不需要区块链" >文章： 不，你可能不需要区块链</a><br/>
8、 <a href="#8物联网技术周报第-132-期:-arduino-与-mindwave-传感器-制作脑控无人机" >物联网技术周报第 132 期: Arduino 与 Mindwave 传感器 制作脑控无人机</a><br/>
9、 <a href="#9dropbox通过自建基础技术设施在两年内省了差不多7500万美元" >Dropbox通过自建基础技术设施在两年内省了差不多7500万美元</a><br/>
10、 <a href="#10vueconfus大会上与gregg-pollack的问答" >VueConf.US大会上与Gregg Pollack的问答</a><br/>
11、 <a href="#11will-sirikits-intents-fit-your-app-if-so-heres-how-to-use-them" >Will SiriKit’s Intents Fit Your App? If So, Here’s How To Use Them</a><br/>
12、 <a href="#12becoming-a-ux-leader" >Becoming A UX Leader</a><br/><h1 id="#title_0" >1、谷歌开源针对iOS的可访问性测试框架</h1>
Sergio De Simone
[http://www.infoq.com/cn/news/2018/04/accessibility-tests-ios-gtxilib?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2018/04/accessibility-tests-ios-gtxilib?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>谷歌GTXiLib是针对iOS的可访问性自动化测试框架，现在它已经基于Apache许可证开源。GTXiLib是使用Objective-C编写的，并且能够与Xcode的单元测试基础设施进行集成。</p> <i>By Sergio De Simone</i> <i> Translated by 张卫滨</i>
---------------
<h1 id="#title_1" >2、文章： electron工具包介绍:用于构建和启动Electron应用程序的Electron应用</h1>
Philipp Langhans
[http://www.infoq.com/cn/articles/introducing-electron-toolkit-the-electron-app?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/introducing-electron-toolkit-the-electron-app?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="https://res.infoq.com/articles/introducing-electron-toolkit-the-electron-app/zh/smallimage/image_code-1523379371762.jpg"/><p>electron工具包是一个用于启动Electron应用的轻量级的、小型的、非常强大的开源应用程序。electron工具包可以在你现有的Electron项目中从npm安装和启动。它可以帮助你构建、发布你的应用，甚至生成完整的网站，其丰富的功能特性可以帮你节约大量的时间。</p> <i>By Philipp Langhans</i> <i> Translated by 孙浩</i>
---------------
<h1 id="#title_2" >3、文章： 深入浅出Java 10的实验性JIT编译器Graal</h1>
郑雨迪
[http://www.infoq.com/cn/articles/java-10-jit-compiler-graal?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/java-10-jit-compiler-graal?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="https://res.infoq.com/articles/java-10-jit-compiler-graal/zh/smallimage/logo (13)-1523461916782.jpg"/><p>Graal是一个以Java为主要编程语言，面向Java bytecode的编译器。与用C++实现的C1及C2相比，它的模块化更加明显，也更加容易维护。Graal既可以作为动态编译器，在运行时编译热点方法；亦可以作为静态编译器，实现AOT编译。在Java 10中，Graal作为试验性JIT compiler一同发布（JEP 317）。这篇文章将介绍Graal在动态编译上的应用。</p> <i>By 郑雨迪</i>
---------------
<h1 id="#title_3" >4、视频演讲： 大规模分布式系统架构下调测能力构建之道</h1>
李鑫
[http://www.infoq.com/cn/presentations/construction-of-down-regulation-of-measurement-capability?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/presentations/construction-of-down-regulation-of-measurement-capability?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="https://res.infoq.com/presentations/construction-of-down-regulation-of-measurement-capability/zh/mediumimage/lixin270-1521963425701.jpg"/><p>如何既享受分布式服务带给我们的好处，又享有单体应用下调测的便利性？我们需要构建一套调测框架，通过这套框架解决分布式服务所带来的服务及数据的依赖问题，从而通过一种轻量化的模式构建起单机调测能力，解决开发人员本地调测需求、提升研发效率。讲师将通过自身的经验来详细展示如何有机结合分布式服务 MOCK（微服务、MQ、Cache、File、DBProxy）、Stub 数据制作及管理、服务直连调测、契约测试保障等能力来构建一套应对研发各阶段开发需求的调测框架及方法论。
</p> <i>By 李鑫</i>
---------------
<h1 id="#title_4" >5、Talk is cheap, show me the architecture</h1>
David
[http://www.infoq.com/cn/news/2018/04/talk-is-cheap?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2018/04/talk-is-cheap?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>就像当年在法拉第表演圆盘发电机被质疑时，法拉第答道:“一个刚刚出生的婴儿有什么作用呢?”</p> <i>By David</i>
---------------
<h1 id="#title_5" >6、在Docker Compose上使用GPU运行TensorFlow</h1>
Beining
[http://www.infoq.com/cn/news/2018/04/Docker-Compose-TensorFlow-GPU?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2018/04/Docker-Compose-TensorFlow-GPU?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>Deep Systems将在Docker Compose上使用GPU运行TensorFlow的经验进行了分享。</p> <i>By Beining</i>
---------------
<h1 id="#title_6" >7、文章： 不，你可能不需要区块链</h1>
Ashton Kemerling
[http://www.infoq.com/cn/articles/no-you-probably-dont-need-a-blockchain?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/articles/no-you-probably-dont-need-a-blockchain?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="https://res.infoq.com/articles/no-you-probably-dont-need-a-blockchain/zh/smallimage/logo-article-1523377077786.jpg"/><p>就算不相信买点比特币就能让你发大财然后迈向人生巅峰，你肯定听说过到处都有人说，比特币并不是未来，真正是未来的应该是区块链！无数人笃信这个观点。但本文作者Ashton Kemerling认为有关区块链的一切都是在做铺垫。区块链不能代表未来，这技术在未来也不会有大范围应用，至少目前还没有相关迹象。</p> <i>By Ashton Kemerling</i> <i> Translated by 大愚若智</i>
---------------
<h1 id="#title_7" >8、物联网技术周报第 132 期: Arduino 与 Mindwave 传感器 制作脑控无人机</h1>
黄峰达
[http://www.infoq.com/cn/news/2018/04/iot-weekly-132?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2018/04/iot-weekly-132?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>Arduino 与 Mindwave 传感器制作脑控无人机；Node-RED 与 Raspberry Pi 构建物联网 MineCraft 城堡；物联网设备六种攻击面及其应对；微软将为 IoT 投入 50 亿美元，物联网大战一触即发；意法半导体 STM32 软件包，让简单的物联网产品具有亚马逊的 Alexa 技术；阿里巴巴重兵布局“云芯片” YoC；MIT 研发“读心机”：你不张嘴就知道想说什么。</p> <i>By 黄峰达</i>
---------------
<h1 id="#title_8" >9、Dropbox通过自建基础技术设施在两年内省了差不多7500万美元</h1>
TOM KRAZIT
[http://www.infoq.com/cn/news/2018/04/Dropbox-7500?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2018/04/Dropbox-7500?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>Dropbox公司在2018年2月23日的S-1公告中称，在决定搭建自己的基础设施并减少对Amazon Web Services的依赖之后，它在两年内减少了7460万美元的运维成本。</p> <i>By TOM KRAZIT</i> <i> Translated by 张健欣</i>
---------------
<h1 id="#title_9" >10、VueConf.US大会上与Gregg Pollack的问答</h1>
Kevin Ball
[http://www.infoq.com/cn/news/2018/04/q-a-with-gregg-pollack-on-vue-js?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global](http://www.infoq.com/cn/news/2018/04/q-a-with-gregg-pollack-on-vue-js?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=global)
<img src="http://www.infoq.com/styles/i/logo_bigger.jpg"/><p>InfoQ择机采访了Pollack，采访内容涉及：Vue.js的内部机制、他对Vue.js社区的看法、学习Vue的最好方法，以及导致Vue成功的更多原因。</p> <i>By Kevin Ball</i> <i> Translated by 盖磊</i>
---------------
<h1 id="#title_10" >11、Will SiriKit’s Intents Fit Your App? If So, Here’s How To Use Them</h1>
Lou Franco
[https://www.smashingmagazine.com/2018/04/sirikit-intents-app-guide/](https://www.smashingmagazine.com/2018/04/sirikit-intents-app-guide/)
<html>
            <head>
              <meta charset="utf-8">
              <link rel="canonical" href="https://www.smashingmagazine.com/2018/04/sirikit-intents-app-guide/" />
              <title>Will SiriKit’s Intents Fit Your App? If So, Here’s How To Use Them</title>
            </head>
            <body>
              <article>
                <header>
                  <h1>Will SiriKit’s Intents Fit Your App? If So, Here’s How To Use Them</h1>
...
<p>The fact that intents can be invoked programmatically by Maps shows how intents might enable inter-app communication in the future.</p>
...
<p>Because the interactions with Siri actually happen outside of your app (maybe even when you app is not running), iOS uses an extension to implement this.</p>
...
<p>Now, create a development provisioning profile for the Intents extension, and regenerate your app’s provisioning profile. Download and install them as you would normally do.</p>
...
<p>For example, when we save the lists, we use this:</p>
...
<p><code>completeResolveListName(with:for:with:)</code> is responsible for deciding what to do with this list of possibilities.</p>
...
<p>Add a stub for the new class:</p>
...
<pre class="break-out"><code class="language-javascript">func handle(intent: INAddTasksIntent, completion: @escaping (INAddTasksIntentResponse) -> Void) {
    var lists = loadLists()
    guard
...
<p>Put this in your main view controller’s <code>viewDidLoad</code> to ask the user for Siri access. This will show the message you configured above and also let the user know that they could be using Siri for this app.</p>
...
<p>Finally, there are some Siri-specific configuration settings:</p>
...
<p>Having identified their strengths and weaknesses and pinpointing areas for improvement, they will have an idea of what they know and — equally important — what they don’t know. As Donald Rumsfeld famously put it:</p>
...
<p>A 360º assessment is a great way to uncover your ‘unknown unknowns’, i.e. the gaps in your knowledge that you aren’t aware of. With these discoveries in hand, it’s possible to build ‘a learning road-map’ that will allow you to develop the skills you need.</p>
...
<p>To lead effectively, it’s important to push outside of your comfort zone and learn about these different specialisms. Do so and you will ensure that you can communicate to these different stakeholders. At the risk of mixing metaphors, you will be the glue that holds the jigsaw together.</p>
